...
from linebot.models import FlexContainer, FlexSendMessage, FollowEvent, MessageAction, MessageEvent, RichMenu, RichMenuArea, RichMenuBounds, RichMenuSize, TextMessage, TextSendMessage
...
def post_message_from_line_bot(message: schemas.Message) -> None:
    ...
    if line_user_ids:
        ...
        line_bot_api.multicast(line_user_ids, FlexSendMessage(contents=FlexContainer.from_json(json.dumps(flex_message))))
...
def post_direct_message_from_line_bot(direct_message: schemas.DirectMessage) -> None:
    if direct_message.send_to.line_user:
        ...
        line_bot_api.push_message(direct_message.send_to.line_user.user_id, FlexSendMessage(contents=FlexContainer.from_json(json.dumps(flex_message))))
