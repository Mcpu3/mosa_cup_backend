...
# def get_my_messages(board_uuid: str, only_sent: bool, only_scheduled: bool, current_user: models.User=Depends(_get_current_user), database: Session=Depends(_get_database)) -> List[schemas.Message]:
